                    ...
                    <div class="card-body">
                        <form action="{{ route('admin#updatePost', $postData['post_id']) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="postTitle" value="{{ old('postTitle',$postData['title']) }}" placeholder="Enter Post Title">
                            ...
                            <div class="form-group">
                             ...
                             <textarea name="postDescription" class="form-control" rows="6" placeholder="Enter Post Description">{{ old('postDescription',$postData['description']) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <img width="100%" class="rounded shadow" @if ( $postData['image'] == null)
                                        src="{{ asset('defaultImage/default-profile.png') }}"
                                    @endif
                                        src="{{ asset('postImage/'.$postData['image']) }}"></td>
                              </div>
