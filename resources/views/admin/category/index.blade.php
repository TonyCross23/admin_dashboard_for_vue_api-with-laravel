            ...
            <div class="col-4">
                <form action="{{ route('admin#categoryCreate') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="categoryName" placeholder="Enter Categroy Name">
                    ...
                    <div class="form-group">
                     ...
                     <textarea name="categoryDescription" class="form-control" rows="6" placeholder="Enter Description"></textarea>
